...
50.times {Mission.create(name: Faker::TvShows::Buffy.unique.episode,
                         scientist: Scientist.all.sample, 
                         planet: Planet.all.sample, planet_id: Planet.all.sample.id, scientist_id: Scientist.all.sample.id)}
